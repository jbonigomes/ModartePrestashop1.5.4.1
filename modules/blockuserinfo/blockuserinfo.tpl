...
<div id="header_user">
	<ul id="header_nav">
		{if !$PS_CATALOG_MODE}
		<li id="shopping_cart">
			<a href="{$link->getPageLink($order_process, true)}" title="{l s='View my shopping bag' mod='blockuserinfo'}" rel="nofollow">
			<i class="glicon-large glicon-shopping-bag"></i> {l s='Shopping Bag' mod='blockuserinfo'}

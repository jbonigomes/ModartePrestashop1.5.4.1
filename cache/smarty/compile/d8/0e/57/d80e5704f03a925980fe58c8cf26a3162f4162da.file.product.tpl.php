...
<?php /*%%SmartyHeaderCode:20447043735239f8cc4823a3-80802581%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '20447043735239f8cc4823a3-80802581',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5239f8cdd0d336_13613676',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5239f8cdd0d336_13613676')) {function content_5239f8cdd0d336_13613676($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Users/jbonigomes/Desktop/projects/ModartePrestashop1.5.4.1/tools/smarty/plugins/modifier.escape.php';
 ...
 <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->unity, 'htmlall', 'UTF-8');?>
			...
			<?php }else{ ?>
				<p id="add_to_cart" class="buttons_bottom_block">
					<button type="submit" name="submit" value="<?php echo smartyTranslate(array('s'=>'Add to Shopping Bag'),$_smarty_tpl);?>
" class="md-border-radius"><i class="icon-gift"></i> <?php echo smartyTranslate(array('s'=>'Add to Shopping Bag'),$_smarty_tpl);?>
</button>
				</p>
			<?php }?>
...
<?php }?>
	...
	<div id="more_info_block">
		<ul id="more_info_tabs" class="idTabs idTabsShort clearfix">
			<?php if ($_smarty_tpl->tpl_vars['product']->value->description){?><li><a id="more_info_tab_more_info" href="#idTab1"><?php echo smartyTranslate(array('s'=>'Description'),$_smarty_tpl);?>
</a></li><?php }?>

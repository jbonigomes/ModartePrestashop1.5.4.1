<?php /* Smarty version Smarty-3.1.13, created on 2013-08-25 12:42:26
         compiled from "/Users/jbonigomes/Desktop/projects/ModartePrestashop1.5.4.1/themes/modarte/product-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20677286155219eda2262840-62478202%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '022aef2f51cb3845871fc7e6a24aaafc938b6aa0' => 
    array (
      0 => '/Users/jbonigomes/Desktop/projects/ModartePrestashop1.5.4.1/themes/modarte/product-list.tpl',
      1 => 1374000685,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20677286155219eda2262840-62478202',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5219eda25f3922_11087005',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5219eda25f3922_11087005')) {function content_5219eda25f3922_11087005($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/Users/jbonigomes/Desktop/projects/ModartePrestashop1.5.4.1/tools/smarty/plugins/modifier.escape.php';
?>
...
" ><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(strip_tags($_smarty_tpl->tpl_vars['product']->value['description_short']),360,'...');?>
				...
				<?php }elseif(isset($_smarty_tpl->tpl_vars['product']->value['reduction'])&&$_smarty_tpl->tpl_vars['product']->value['reduction']&&isset($_smarty_tpl->tpl_vars['product']->value['show_price'])&&$_smarty_tpl->tpl_vars['product']->value['show_price']&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?><span class="discount"><i class="icon-tag"></i></span><?php }?>
			</div>
...
<?php }?></span><?php }?>
					<?php if (isset($_smarty_tpl->tpl_vars['product']->value['available_for_order'])&&$_smarty_tpl->tpl_vars['product']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)){?><?php }?>
				</div>
...
"><?php echo smartyTranslate(array('s'=>'Add to Shopping Bag'),$_smarty_tpl);?>
</a>
						<?php }else{ ?>
							<a class="button ajax_add_to_cart_button exclusive" rel="ajax_id_product_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_product']);?>
...
"><?php echo smartyTranslate(array('s'=>'Add to Shopping Bag'),$_smarty_tpl);?>
						...
						<?php }?>						
					<?php }else{ ?>
						</span><?php echo smartyTranslate(array('s'=>'Add to Shopping bag'),$_smarty_tpl);?>
</span><br />
					<?php }?>
				<?php }?>
...
"><i class="icon-eye-open"></i> <?php echo smartyTranslate(array('s'=>'View'),$_smarty_tpl);?>
</a>
			</div>
		</li>
	<?php } ?>

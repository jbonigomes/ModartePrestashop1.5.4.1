<?php /* Smarty version Smarty-3.1.13, created on 2013-07-08 20:20:46
         compiled from "/Users/jbonigomes/Desktop/projects/ModartePrestashop1.5.4.1/adminMod/themes/default/template/controllers/customers/helpers/view/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:44250599651db110e802038-44822294%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '725a4e162e89095590e638264eb952b427823894' => 
    array (
      0 => '/Users/jbonigomes/Desktop/projects/ModartePrestashop1.5.4.1/adminMod/themes/default/template/controllers/customers/helpers/view/view.tpl',
      1 => 1366896186,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '44250599651db110e802038-44822294',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51db110f2b0d49_61317958',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51db110f2b0d49_61317958')) {function content_51db110f2b0d49_61317958($_smarty_tpl) {?>
...
&note="+noteContent,
				...
				success: function(r) {
					...
					if (r == 'ok')
					{
						...
						$('#note_feedback').html("<b style='color:red'><?php echo smartyTranslate(array('s'=>'Error: Your note cannot be saved.'),$_smarty_tpl);?>
</b>").fadeIn(400);
...
">
 ...
 <?php if (isset($_smarty_tpl->tpl_vars['customerLanguage']->value)){?><?php echo $_smarty_tpl->tpl_vars['customerLanguage']->value->name;?>
<?php }else{ ?><?php echo smartyTranslate(array('s'=>'undefined'),$_smarty_tpl);?>
<?php }?><br />
...
" />
						<p class="center"><input class="button" type="submit" name="submitGuestToCustomer" value="<?php echo smartyTranslate(array('s'=>'Transform to a customer account'),$_smarty_tpl);?>
" /></p>
				...
				<?php }else{ ?>
					</div><div><b style="color:red;"><?php echo smartyTranslate(array('s'=>'A registered customer account using the defined email address already exists. '),$_smarty_tpl);?>
</b>
				<?php }?>
			</div>
		<?php }?>
...
<div class="clear"></div>
	...
	<div>
		...
		<p><?php echo smartyTranslate(array('s'=>'This note will be displayed to all employees but not to customers.'),$_smarty_tpl);?>
</p>
		...
		<?php if (count($_smarty_tpl->tpl_vars['messages']->value)){?>
			<table cellspacing="0" cellpadding="0" class="table" style="width:100%;">
				<tr>
					...
					<th class="left"><?php echo smartyTranslate(array('s'=>'Message'),$_smarty_tpl);?>
</th>
					<th class="left"><?php echo smartyTranslate(array('s'=>'Sent on'),$_smarty_tpl);?>
</th>
				</tr>
...
?>
					<tr>
						<td class="left"><?php echo $_smarty_tpl->tpl_vars['message']->value['status'];?>
</td>
						<td class="left">
...
...
						...
						<td class="left"><?php echo $_smarty_tpl->tpl_vars['message']->value['date_add'];?>
</td>
					</tr>
				<?php } ?>
			</table>
 ...
 <?php echo $_smarty_tpl->tpl_vars['total_ok']->value;?>
				...
				<table cellspacing="0" cellpadding="0" class="table" style="width:100%; text-align:left;">
					...
					<tr>
						...
						<th class="right"><?php echo smartyTranslate(array('s'=>'Products'),$_smarty_tpl);?>
</th>
						<th class="right"><?php echo smartyTranslate(array('s'=>'Total spent'),$_smarty_tpl);?>
</th>
...
'">
							<td class="left"><?php echo $_smarty_tpl->tpl_vars['order']->value['id_order'];?>
</td>
							<td class="left"><?php echo $_smarty_tpl->tpl_vars['order']->value['date_add'];?>
</td>
							<td class="left"><?php echo $_smarty_tpl->tpl_vars['order']->value['payment'];?>
</td>
							<td class="left"><?php echo $_smarty_tpl->tpl_vars['order']->value['order_state'];?>
</td>
			...
			<?php if ($_smarty_tpl->tpl_vars['carts']->value&&count($_smarty_tpl->tpl_vars['carts']->value)){?>
				<table cellspacing="0" cellpadding="0" class="table" style="width:100%">
					...
					<tr>
						...
						<th class="left"><?php echo smartyTranslate(array('s'=>'Carrier'),$_smarty_tpl);?>
</th>
						<th class="right"><?php echo smartyTranslate(array('s'=>'Total'),$_smarty_tpl);?>
</th>
						<th class="center"><?php echo smartyTranslate(array('s'=>'Actions'),$_smarty_tpl);?>
</th>
					</tr>
...
'">
							<td class="left"><?php echo $_smarty_tpl->tpl_vars['cart']->value['id_cart'];?>
</td>
							<td class="left"><?php echo $_smarty_tpl->tpl_vars['cart']->value['date_add'];?>
</td>
							<td class="left"><?php echo $_smarty_tpl->tpl_vars['cart']->value['name'];?>
</td>
 ...
 (<?php echo count($_smarty_tpl->tpl_vars['addresses']->value);?>
		...
		<?php if (count($_smarty_tpl->tpl_vars['addresses']->value)){?>
			<table cellspacing="0" cellpadding="0" class="table" style="width:100%;">
				...
				<tr>
					<th class="left" height="39px"><?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>
</th>
					<th class="left"><?php echo smartyTranslate(array('s'=>'Name'),$_smarty_tpl);?>
</th>
					<th class="left"><?php echo smartyTranslate(array('s'=>'Address'),$_smarty_tpl);?>
</th>
					<th class="left"><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
</th>
					<th class="right"><?php echo smartyTranslate(array('s'=>'Phone number(s)'),$_smarty_tpl);?>
</th>
					<th class="center"><?php echo smartyTranslate(array('s'=>'Actions'),$_smarty_tpl);?>
</th>
				</tr>
...
?>
					<tr <?php if ($_smarty_tpl->tpl_vars['key']->value%2){?>class="alt_row"<?php }?>>
						<td class="left"><?php if ($_smarty_tpl->tpl_vars['address']->value['company']){?><?php echo $_smarty_tpl->tpl_vars['address']->value['company'];?>
<?php }else{ ?>--<?php }?></td>
						<td class="left"><?php echo $_smarty_tpl->tpl_vars['address']->value['firstname'];?>
 <?php echo $_smarty_tpl->tpl_vars['address']->value['lastname'];?>
</td>
						<td class="left"><?php echo $_smarty_tpl->tpl_vars['address']->value['address1'];?>
...
<?php }?> <?php echo $_smarty_tpl->tpl_vars['address']->value['postcode'];?>
 <?php echo $_smarty_tpl->tpl_vars['address']->value['city'];?>
						...
						<td class="left"><?php echo $_smarty_tpl->tpl_vars['address']->value['country'];?>
</td>
						<td class="right">
...
'">
						<td class="left"><?php echo $_smarty_tpl->tpl_vars['group']->value['id_group'];?>
</td>
						<td class="left"><?php echo $_smarty_tpl->tpl_vars['group']->value['name'];?>
</td>
						<td class="center"><a href="?tab=AdminGroups&id_group=<?php echo $_smarty_tpl->tpl_vars['group']->value['id_group'];?>
&viewgroup&token=<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['getAdminToken'][0][0]->getAdminTokenLiteSmarty(array('tab'=>'AdminGroups'),$_smarty_tpl);?>
"><img src="../img/admin/details.gif" /></a></td>
					</tr>
				<?php } ?>
...
"><img src="../img/admin/details.gif" /></a></td>
	...
	<?php if (count($_smarty_tpl->tpl_vars['connections']->value)){?>
		...
		<table cellspacing="0" cellpadding="0" class="table" style="width:100%;">
			...
			<tr>
				<th class="left" height="39px;"><?php echo smartyTranslate(array('s'=>'Date'),$_smarty_tpl);?>
</th>
				<th class="left"><?php echo smartyTranslate(array('s'=>'Pages viewed'),$_smarty_tpl);?>
</th>
				<th class="left"><?php echo smartyTranslate(array('s'=>'Total time'),$_smarty_tpl);?>
</th>
				<th class="left"><?php echo smartyTranslate(array('s'=>'Origin'),$_smarty_tpl);?>
</th>
				<th class="left"><?php echo smartyTranslate(array('s'=>'IP Address'),$_smarty_tpl);?>
</th>
			</tr>
...
?>
				<tr>
					<td class="left"><?php echo $_smarty_tpl->tpl_vars['connection']->value['date_add'];?>
</td>
					<td class="left"><?php echo $_smarty_tpl->tpl_vars['connection']->value['pages'];?>
</td>
					<td class="left"><?php echo $_smarty_tpl->tpl_vars['connection']->value['time'];?>
</td>
					<td class="left"><?php echo $_smarty_tpl->tpl_vars['connection']->value['http_referer'];?>
</td>
					<td class="left"><?php echo $_smarty_tpl->tpl_vars['connection']->value['ipaddress'];?>
</td>
				</tr>
			<?php } ?>
		</table>
			...
			<?php if (count($_smarty_tpl->tpl_vars['referrers']->value)){?>
				...
				<table cellspacing="0" cellpadding="0" class="table" style="width:100%">
					<tr>
						...
						<?php if ($_smarty_tpl->tpl_vars['shop_is_feature_active']->value){?><th class="left"><?php echo smartyTranslate(array('s'=>'Shop'),$_smarty_tpl);?>
</th><?php }?>
					</tr>
...
?>
						<tr>
							<td class="left"><?php echo $_smarty_tpl->tpl_vars['referrer']->value['date_add'];?>
</td>
							<td class="left"><?php echo $_smarty_tpl->tpl_vars['referrer']->value['name'];?>
</td>
							<?php if ($_smarty_tpl->tpl_vars['shop_is_feature_active']->value){?><td class="left"><?php echo $_smarty_tpl->tpl_vars['referrer']->value['shop_name'];?>
</td><?php }?>
						</tr>
					<?php } ?>
				</table>
